   ...
   return (
    <section className='mx-w-7xl mx-auto'>
        <div>
            ...
            <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>Browse through a collection of imaginative and visually stunning images generated by SAKK-Y AI</p>
        </div>
        ...
        <div className='mt-16'>
            ...
            value={searchText}
            handleChange={handeleSearchChange}
            />
        </div>
