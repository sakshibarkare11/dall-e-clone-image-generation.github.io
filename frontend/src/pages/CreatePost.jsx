...
const CreatePost = () => {
    ...
    const handleSubmit = async(e) => {
        ...
        if(form.prompt && form.photo)
        {
            ...
            await response.json();
            navigate('/');// share to community loads homepage due to this response successful and navigate is after the await
  ...
  return (
    <section className='max-w-7xl mx-auto'>
        <div>
            ...
            <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'> Create imaginative and visually stunning images through SAKK-Y AI and share tham with community</p>
        </div>
